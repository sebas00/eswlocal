...
(function(baseEmbeddedSvc) {
	...
	Snapins.prototype.setupMessageListener = function setupMessageListener() {
		window.addEventListener("message", function(message) {
			...
			var isMessageOriginValidProtocol = true;
			//r iframeOrigin = embedded_svc.utils.getHostnameFromUrl(this.settings.iframeURL);
			var feature;
			var oldHost;
			var newHost;
			 ...
			 */
			if(payload && payload.method && isMessageOriginValidProtocol ) {
