embedded_svc.defineFeature("Invite",function(f){function J(a){var b;if(void 0!==a.style.animationName)return"";["Webkit","Moz","O","ms","Khtml"].forEach(function(d){void 0!==a.style[d+"AnimationName"]&&(b=d.toLowerCase())});return b}function K(a,b,d){if(a.addEventListener)a.addEventListener(b,d,!1);else if(a.attachEvent)a.attachEvent("on"+b,d,!1);else throw Error("Could not add event listener");}function p(){}function n(){}function e(){}function B(a){this.ruleId=a;n.prototype.init.call(this,null,
null)}function C(a,b){n.prototype.init.call(this,a,b)}function D(a,b){n.prototype.init.call(this,a,b)}function E(a){n.prototype.init.call(this,a,null)}function w(a){return m(a)?m(a).getTracker():null}function k(){}function t(a,b,d,c){k.prototype.init.call(this,a,b,d,c)}function u(a,b,d,c){k.prototype.init.call(this,a,b,null,c)}function x(a,b,d,c){k.prototype.init.call(this,a,b,null,c)}function g(a){p.prototype.init.call(this,a,p.TYPE.INVITE);this.active=!1;this.filterLogic=null;this.rules={};this.autoRejectTimeout=
this.inviteTimeout=this.inviteDelay=this.ruleTree=null}function m(a){F[a]||(F[a]=new g(a));return F[a]}function y(a,b,d,c,h){e.prototype.init.call(this,a,b,d,c,h)}function z(a,b,d,c,h){e.prototype.init.call(this,a,b,d,c,h)}function G(a,b,d,c,h){e.prototype.init.call(this,a,b,d,c,h)}function r(a){var b=0,d=0,c;L+=1;if(1E3<L)throw Error("Error processing rule filter logic, preventing recursion");for(c=0;c<a.length;c+=1)"("===a.charAt(c)?d+=1:")"===a.charAt(c)&&--d,","===a.charAt(c)&&1===d&&(b=c);if(0===
a.indexOf("AND("))return d=r(a.substring(4,b)),a=r(a.substring(b+1,a.length-1)),new C(d,a);if(0===a.indexOf("OR("))return d=r(a.substring(3,b)),a=r(a.substring(b+1,a.length-1)),new D(d,a);if(0===a.indexOf("NOT("))return d=r(a.substring(4,a.length-1)),new E(d);if(!isNaN(parseInt(a,10)))return new B(parseInt(a,10));throw Error("Encountered unexpected character in filter logic");}function q(a,b,d,c,h,l,M,N){this.buttonId=a;this.element=b;this.hasInviteAfterAccept=l;this.hasInviteAfterReject=M;this.rejectTime=
N;null===J(b)?this.renderer=new g.RENDERER.Appear.RenderClass(a,b,g.START_POSITION[c],g.END_POSITION[h]):this.renderer=new g.RENDERER[d].RenderClass(a,b,g.START_POSITION[c],g.END_POSITION[h])}var H=!1,I={},v={},F={},L=0,A=new function(){this.init=function(){var a=parseInt(window.localStorage.getItem("snapinsPc"),10)||0;window.localStorage.getItem("snapinsStart")||window.localStorage.setItem("snapinsStart",(new Date).getTime().toString());window.localStorage.setItem("snapinsPc",(a+1).toString());window.localStorage.setItem("snapinsPage_"+
...
"10000";this.element.style.display="";this.element.style.visibility="visible";this.width=this.element.offsetWidth;this.height=this.element.offsetHeight;this.startPosition=d;this.endPosition=c};k.prototype.render=function(){this.element.style.display=""};k.prototype.renderFinish=function(){};k.prototype.remove=function(a){this.element.style.left="-1000px";this.element.style.top="-1000px"};k.prototype.addRenderListeners=function(){var a=this.buttonId,b="AnimationIteration",d="AnimationEnd";""===this.animationPrefix?
(b=b.toLowerCase(),d=d.toLowerCase()):(b=this.animationPrefix+b,d=this.animationPrefix+d);K(this.element,b,function(){w(a).renderFinish()});K(this.element,d,function(){w(a).removeFinish()})};t.prototype=new k;t.prototype.render=function(){var a=this.width*this.startPosition.xPosition+this.offset*this.startPosition.xOffset,b=this.height*this.startPosition.yPosition+this.offset*this.startPosition.yOffset,d=this.width*this.endPosition.xPercent*-1+this.offset*this.endPosition.xOffset,c=this.height*this.endPosition.yPercent*
-1+this.offset*this.endPosition.yOffset,h=document.createElement("style"),l="";k.prototype.addRenderListeners.call(this);""!==this.animationPrefix&&(l="-"+this.animationPrefix+"-");h.innerHTML="@"+l+"keyframes slide"+this.buttonId+"{from { margin-left: "+a+"px; margin-top: "+b+"px; left: "+100*this.startPosition.xPercent+"%; top: "+100*this.startPosition.yPercent+"%; }to { margin-left: "+d+"px; margin-top: "+c+"px; left: "+100*this.endPosition.xPercent+"%; top: "+100*this.endPosition.yPercent+"%; }}";
...
(b="-"+this.animationPrefix+"-");a?(this.element.style[b+"animation-play-state"]="running",this.element.style.setProperty(b+"animation-play-state","running","")):(this.element.style[b+"animation-name"]="",this.element.style.setProperty(b+"animation-name","",""),k.prototype.remove.call(this,a))};u.prototype=new k;u.prototype.render=function(){var a="",b=document.createElement("style"),d=this.width*this.endPosition.xPercent*-1+this.offset*this.endPosition.xOffset,c=this.height*this.endPosition.yPercent*
...
(H=!0,this.renderer.render()):!a&&m(this.buttonId).isActive()&&(H=!1,this.remove(!0))};q.prototype.renderFinish=function(){var a=this.buttonId;m(this.buttonId).setActive(!0);-1!==this.rejectTime&&m(this.buttonId).setAutoRejectTimeout(window.setTimeout(function(){m(a).rejectInvite()},1E3*this.rejectTime));this.renderer.renderFinish()};q.prototype.hasCookieConsent=function(a){var b=[];return 0>["liveagent_invite_rejected_"].indexOf(a)||0>b.indexOf(window.location.host)};q.prototype.accept=function(){!this.hasInviteAfterAccept&&
this.hasCookieConsent("liveagent_invite_rejected_")&&f.setCookie("liveagent_invite_rejected_"+this.buttonId,!0,!1);this.remove(!1)};q.prototype.reject=function(){!this.hasInviteAfterReject&&this.hasCookieConsent("liveagent_invite_rejected_")&&f.setCookie("liveagent_invite_rejected_"+this.buttonId,!0,!1);this.remove(!0)};q.prototype.remove=function(a){m(this.buttonId).setActive(!1);this.renderer.remove(a)};q.prototype.removeFinish=function(){this.renderer.remove(!1)};g.prototype.setRules=function(a,
b){var d;if(a&&b){for(d in a)if(a.hasOwnProperty(d)){var c=a[d];var h=null;switch(c.type){case e.TYPE.NUMBER_OF_PAGE_VIEWS:h=new y(c.order,this.buttonId,A.getPageCount(),c.operator,parseInt(c.value,10));break;case e.TYPE.URL_MATCH:h=new y(c.order,this.buttonId,A.getCurrentPage(),c.operator,c.value);break;case e.TYPE.SECONDS_ON_PAGE:h=new z(c.order,this.buttonId,(new Date).getTime(),c.operator,1E3*parseInt(c.value,10));break;case e.TYPE.SECONDS_ON_SITE:h=new z(c.order,this.buttonId,parseInt(A.getSessionStart(),
10),c.operator,1E3*parseInt(c.value,10));break;case e.TYPE.CUSTOM_VARIABLE:h=new G(c.order,this.buttonId,c.name,c.operator,c.value),v.hasOwnProperty(c.name)||(v[c.name]=[]),v[c.name].push(this.buttonId)}null!==h&&this.addRule(h)}this.filterLogic=b;this.ruleTree=r(b)}};g.prototype.setOnlineState=function(a){a||null===this.inviteTimeout||(clearTimeout(this.inviteTimeout),this.inviteTimeout=null);a||null===this.autoRejectTimeout||(clearTimeout(this.autoRejectTimeout),this.autoRejectTimeout=null);p.prototype.setOnlineState.call(this,
a)};g.prototype.isActive=function(){return this.active};g.prototype.setActive=function(a){document.getElementById("snapins_invite")&&(document.getElementById("snapins_invite").inert=!a);this.active=a};g.prototype.addTracker=function(a,b){a=/Mobi/.test(navigator.userAgent)?new q(b.id,a,"Fade",void 0,"BottomRight",b.hasInviteAfterAccept,b.hasInviteAfterReject,b.inviteRejectTime):new q(b.id,a,b.inviteRenderer,b.inviteStartPosition,b.inviteEndPosition,b.hasInviteAfterAccept,b.hasInviteAfterReject,b.inviteRejectTime);
this.trackers=[];this.trackers.push(a)};g.prototype.getTracker=function(){if(1<this.trackers.length)throw Error("InviteButtons should have less than 1 tracker");return this.trackers[0]};g.prototype.acceptInvite=function(){f.onHelpButtonClick();this.getTracker().accept();embedded_svc.utils.fireEvent("onInviteAccepted")};g.prototype.rejectInvite=function(){this.getTracker().reject();embedded_svc.utils.fireEvent("onInviteRejected")};g.prototype.setCustomVariable=function(a,b){var d;I[a]=b;v.hasOwnProperty(a)&&
v[a].forEach(function(c){d=m(c);d.getOnlineState()&&d.setOnlineState(!0)})};g.prototype.trigger=function(){var a=!0,b=this,d=f.componentInitInProgress||0<document.getElementsByClassName("embeddedServiceSidebar").length;if(f.getCookie("liveagent_invite_rejected_"+this.buttonId)||d)return!1;null!==this.ruleTree&&(f.log("Invite "+this.buttonId+" Rule Evaluation"),f.log("Filter Logic: "+this.filterLogic),a=this.ruleTree.evaluate(this));a||null===this.inviteDelay||(this.inviteTimeout=window.setTimeout(function(){b.setOnlineState(!0)},
this.inviteDelay),this.inviteDelay=null);return a};g.prototype.addRule=function(a){this.rules[a.getId()]=a};g.prototype.getRule=function(a){return this.rules[a]};g.prototype.getInviteDelay=function(){return this.inviteDelay};g.prototype.setInviteDelay=function(a){f.log("Setting invite delay to: "+a);this.inviteDelay=a};g.prototype.setAutoRejectTimeout=function(a){this.autoRejectTimeout=a};f.inviteAPI=new function(){this.inviteButton=m(f.settings.buttonId);A.init();if(document.getElementById("embeddedServiceAvatar"))if(embedded_svc.settings.avatarImgURL)document.getElementById("embeddedServiceAvatar").src=
